...
grep -E -v '^(third_party/|docs/consolidation/|testdata/consolidation/|scripts/(check-(abi-fixture|consolidation-guardrails|dependencies|external-consumers|journeys|removal-ratchet)|run-consolidation-journeys|test-guardrails)\.sh$)' \
