...
// Run starts the all-in-one control plane and optional embedded SSH gateway.
func Run(args []string) {
	previousArgs, previousFlags := os.Args, flag.CommandLine
	os.Args = append([]string{"plumtree"}, args...)
	flag.CommandLine = flag.NewFlagSet("plumtree", flag.ExitOnError)
	defer func() {
