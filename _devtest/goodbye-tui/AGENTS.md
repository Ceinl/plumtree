...
This is a Plumtree tui app named `goodbye-tui`.

## Commands

- Run locally: `pt dev`
- Deterministic smoke check: `pt dev --headless --script "up,up,down,q"`
...
- This app demonstrates `sdk.SetGoodbye`: before quitting it sets a goodbye message
  that the SSH gateway displays after closing the alt-screen.
